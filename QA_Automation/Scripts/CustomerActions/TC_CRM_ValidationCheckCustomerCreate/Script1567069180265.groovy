...
CustomKeywords.'customer.Common_CustomerKeywords.validationTextFields'('Save',1)

//CustomKeywords.'customer.Common_CustomerKeywords.aesteriskCheck'('Save')

CustomKeywords.'customer.Common_CustomerKeywords.validationAlertForCustomerDropdowns'('Save',1)
